...
#define H_SYSTEM_PROC_NUMBER 2101
#endif
...
LIntExport Herror create_scattered_data_interpolator(const Halcon::HTuple &Method, const Halcon::HTuple &Rows, const Halcon::HTuple &Columns, const Halcon::HTuple &Values, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ScatteredDataInterpolatorHandle);
LIntExport Herror create_scattered_data_interpolator(const Halcon::HTuple &Method, const Halcon::HTuple &Rows, const Halcon::HTuple &Columns, const Halcon::HTuple &Values, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ScatteredDataInterpolatorHandle);
LIntExport Herror interpolate_scattered_data_points_to_image(Halcon::Hobject *ImageInterpolated, const Halcon::HTuple &Method, const Halcon::HTuple &Rows, const Halcon::HTuple &Columns, const Halcon::HTuple &Values, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror interpolate_scattered_data_image(const Halcon::Hobject &Image, const Halcon::Hobject &RegionInterpolate, Halcon::Hobject *ImageInterpolated, const Halcon::HTuple &Method, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror get_compute_device_param(const Halcon::HTuple &DeviceHandle, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_compute_device_param(const Halcon::HTuple &DeviceHandle, const Halcon::HTuple &GenParamName, char *GenParamValue);
LIntExport Herror get_compute_device_param(Hlong DeviceHandle, const char *GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_compute_device_param(Hlong DeviceHandle, const char *GenParamName, char *GenParamValue);
LIntExport Herror set_compute_device_param(const Halcon::HTuple &DeviceHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror get_socket_param(const Halcon::HTuple &Socket, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_socket_param(const Halcon::HTuple &Socket, const Halcon::HTuple &GenParamName, char *GenParamValue);
LIntExport Herror get_socket_param(Hlong Socket, const char *GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_socket_param(Hlong Socket, const char *GenParamName, char *GenParamValue);
LIntExport Herror set_socket_param(const Halcon::HTuple &Socket, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror query_sheet_of_light_params(const Halcon::HTuple &SheetOfLightModelID, const Halcon::HTuple &QueryName, Halcon::HTuple *GenParamName);
LIntExport Herror query_sheet_of_light_params(Hlong SheetOfLightModelID, const char *QueryName, Halcon::HTuple *GenParamName);
...
LIntExport Herror create_sheet_of_light_model(const Halcon::Hobject &ProfileRegion, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *SheetOfLightModelID);
LIntExport Herror create_sheet_of_light_model(const Halcon::Hobject &ProfileRegion, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *SheetOfLightModelID);
LIntExport Herror create_sheet_of_light_model(const Halcon::Hobject &ProfileRegion, const char *GenParamName, Hlong GenParamValue, Halcon::HTuple *SheetOfLightModelID);
LIntExport Herror create_sheet_of_light_model(const Halcon::Hobject &ProfileRegion, const char *GenParamName, Hlong GenParamValue, Hlong *SheetOfLightModelID);
...
LIntExport Herror fit_primitives_object_model_3d(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ObjectModel3DOut);
LIntExport Herror fit_primitives_object_model_3d(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ObjectModel3DOut);
LIntExport Herror segment_object_model_3d(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ObjectModel3DOut);
LIntExport Herror segment_object_model_3d(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ObjectModel3DOut);
...
LIntExport Herror create_text_model_reader(const Halcon::HTuple &Mode, const Halcon::HTuple &OCRClassifier, Halcon::HTuple *TextModel);
LIntExport Herror create_text_model_reader(const Halcon::HTuple &Mode, const Halcon::HTuple &OCRClassifier, Hlong *TextModel);
...
LIntExport Herror get_stereo_model_param(const Halcon::HTuple &StereoModelID, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_stereo_model_param(Hlong StereoModelID, const char *GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror set_stereo_model_param(const Halcon::HTuple &StereoModelID, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror optimize_aop(const Halcon::HTuple &OperatorName, const Halcon::HTuple &IconicType, const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror write_aop_knowledge(const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror read_aop_knowledge(const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Attributes, Halcon::HTuple *OperatorNames);
...
LIntExport Herror create_ocr_class_knn(const Halcon::HTuple &WidthCharacter, const Halcon::HTuple &HeightCharacter, const Halcon::HTuple &Interpolation, const Halcon::HTuple &Features, const Halcon::HTuple &Characters, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *OCRHandle);
LIntExport Herror create_ocr_class_knn(const Halcon::HTuple &WidthCharacter, const Halcon::HTuple &HeightCharacter, const Halcon::HTuple &Interpolation, const Halcon::HTuple &Features, const Halcon::HTuple &Characters, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *OCRHandle);
LIntExport Herror trainf_ocr_class_knn(const Halcon::HTuple &OCRHandle, const Halcon::HTuple &TrainingFile, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror select_feature_set_trainf_knn(const Halcon::HTuple &TrainingFile, const Halcon::HTuple &FeatureList, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *OCRHandle, Halcon::HTuple *FeatureSet, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_trainf_mlp_protected(const Halcon::HTuple &TrainingFile, const Halcon::HTuple &Password, const Halcon::HTuple &FeatureList, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *OCRHandle, Halcon::HTuple *FeatureSet, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_trainf_mlp(const Halcon::HTuple &TrainingFile, const Halcon::HTuple &FeatureList, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *OCRHandle, Halcon::HTuple *FeatureSet, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_trainf_svm_protected(const Halcon::HTuple &TrainingFile, const Halcon::HTuple &Password, const Halcon::HTuple &FeatureList, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *OCRHandle, Halcon::HTuple *FeatureSet, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_trainf_svm(const Halcon::HTuple &TrainingFile, const Halcon::HTuple &FeatureList, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *OCRHandle, Halcon::HTuple *FeatureSet, Halcon::HTuple *Score);
...
LIntExport Herror get_sample_identifier_param(const Halcon::HTuple &SampleIdentifier, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_sample_identifier_param(const Halcon::HTuple &SampleIdentifier, const Halcon::HTuple &GenParamName, double *GenParamValue);
LIntExport Herror get_sample_identifier_param(Hlong SampleIdentifier, const char *GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_sample_identifier_param(Hlong SampleIdentifier, const char *GenParamName, double *GenParamValue);
LIntExport Herror set_sample_identifier_param(const Halcon::HTuple &SampleIdentifier, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror train_sample_identifier(const Halcon::HTuple &SampleIdentifier, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror create_sample_identifier(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *SampleIdentifier);
LIntExport Herror create_sample_identifier(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *SampleIdentifier);
...
LIntExport Herror set_shape_model_param(const Halcon::HTuple &ModelID, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror set_deformable_model_param(const Halcon::HTuple &ModelID, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror get_deformable_model_params(const Halcon::HTuple &ModelID, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_deformable_model_params(const Halcon::HTuple &ModelID, const Halcon::HTuple &GenParamName, char *GenParamValue);
LIntExport Herror get_deformable_model_params(Hlong ModelID, const char *GenParamName, Halcon::HTuple *GenParamValue);
...
LIntExport Herror find_local_deformable_model(const Halcon::Hobject &Image, Halcon::Hobject *ImageRectified, Halcon::Hobject *VectorField, Halcon::Hobject *DeformedContours, const Halcon::HTuple &ModelID, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleRMin, const Halcon::HTuple &ScaleRMax, const Halcon::HTuple &ScaleCMin, const Halcon::HTuple &ScaleCMax, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &NumLevels, const Halcon::HTuple &Greediness, const Halcon::HTuple &ResultType, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Score, Halcon::HTuple *Row, Halcon::HTuple *Column);
LIntExport Herror find_planar_calib_deformable_model(const Halcon::Hobject &Image, const Halcon::HTuple &ModelID, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleRMin, const Halcon::HTuple &ScaleRMax, const Halcon::HTuple &ScaleCMin, const Halcon::HTuple &ScaleCMax, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &NumLevels, const Halcon::HTuple &Greediness, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Pose, Halcon::HTuple *CovPose, Halcon::HTuple *Score);
LIntExport Herror find_planar_uncalib_deformable_model(const Halcon::Hobject &Image, const Halcon::HTuple &ModelID, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &ScaleRMin, const Halcon::HTuple &ScaleRMax, const Halcon::HTuple &ScaleCMin, const Halcon::HTuple &ScaleCMax, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &NumLevels, const Halcon::HTuple &Greediness, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *HomMat2D, Halcon::HTuple *Score);
...
LIntExport Herror set_ncc_model_param(const Halcon::HTuple &ModelID, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror get_deformable_surface_model_param(const Halcon::HTuple &DeformableSurfaceModel, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_deformable_surface_model_param(const Halcon::HTuple &DeformableSurfaceModel, const Halcon::HTuple &GenParamName, double *GenParamValue);
LIntExport Herror get_deformable_surface_model_param(Hlong DeformableSurfaceModel, const char *GenParamName, Halcon::HTuple *GenParamValue);
...
LIntExport Herror get_surface_model_param(const Halcon::HTuple &SurfaceModelID, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_surface_model_param(const Halcon::HTuple &SurfaceModelID, const Halcon::HTuple &GenParamName, double *GenParamValue);
LIntExport Herror get_surface_model_param(Hlong SurfaceModelID, const char *GenParamName, Halcon::HTuple *GenParamValue);
...
LIntExport Herror get_shape_model_3d_params(const Halcon::HTuple &ShapeModel3DID, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_shape_model_3d_params(const Halcon::HTuple &ShapeModel3DID, const Halcon::HTuple &GenParamName, char *GenParamValue);
LIntExport Herror get_shape_model_3d_params(Hlong ShapeModel3DID, const char *GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_shape_model_3d_params(Hlong ShapeModel3DID, const char *GenParamName, char *GenParamValue);
LIntExport Herror find_shape_model_3d(const Halcon::Hobject &Image, const Halcon::HTuple &ShapeModel3DID, const Halcon::HTuple &MinScore, const Halcon::HTuple &Greediness, const Halcon::HTuple &NumLevels, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Pose, Halcon::HTuple *CovPose, Halcon::HTuple *Score);
LIntExport Herror create_shape_model_3d(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &CamParam, const Halcon::HTuple &RefRotX, const Halcon::HTuple &RefRotY, const Halcon::HTuple &RefRotZ, const Halcon::HTuple &OrderOfRotation, const Halcon::HTuple &LongitudeMin, const Halcon::HTuple &LongitudeMax, const Halcon::HTuple &LatitudeMin, const Halcon::HTuple &LatitudeMax, const Halcon::HTuple &CamRollMin, const Halcon::HTuple &CamRollMax, const Halcon::HTuple &DistMin, const Halcon::HTuple &DistMax, const Halcon::HTuple &MinContrast, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ShapeModel3DID);
LIntExport Herror create_shape_model_3d(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &CamParam, const Halcon::HTuple &RefRotX, const Halcon::HTuple &RefRotY, const Halcon::HTuple &RefRotZ, const Halcon::HTuple &OrderOfRotation, const Halcon::HTuple &LongitudeMin, const Halcon::HTuple &LongitudeMax, const Halcon::HTuple &LatitudeMin, const Halcon::HTuple &LatitudeMax, const Halcon::HTuple &CamRollMin, const Halcon::HTuple &CamRollMax, const Halcon::HTuple &DistMin, const Halcon::HTuple &DistMax, const Halcon::HTuple &MinContrast, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ShapeModel3DID);
...
LIntExport Herror distance_object_model_3d(const Halcon::HTuple &ObjectModel3DFrom, const Halcon::HTuple &ObjectModel3DTo, const Halcon::HTuple &Pose, const Halcon::HTuple &MaxDistance, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror get_object_model_3d_params(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_object_model_3d_params(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &GenParamName, char *GenParamValue);
...
LIntExport Herror get_window_param(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Param, char *Value);
...
LIntExport Herror get_line_width(const Halcon::HTuple &WindowHandle, double *Width);
...
LIntExport Herror set_drawing_object_params(const Halcon::HTuple &DrawID, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror set_drawing_object_params(Hlong DrawID, const char *GenParamName, double GenParamValue);
LIntExport Herror get_drawing_object_params(const Halcon::HTuple &DrawID, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_drawing_object_params(const Halcon::HTuple &DrawID, const Halcon::HTuple &GenParamName, double *GenParamValue);
LIntExport Herror get_drawing_object_params(Hlong DrawID, const char *GenParamName, Halcon::HTuple *GenParamValue);
...
LIntExport Herror read_polygon_xld_dxf(Halcon::Hobject *Polygons, const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *DxfStatus);
LIntExport Herror read_polygon_xld_dxf(Halcon::Hobject *Polygons, const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, char *DxfStatus);
LIntExport Herror read_polygon_xld_dxf(Halcon::Hobject *Polygons, const char *FileName, const char *GenParamName, double GenParamValue, Halcon::HTuple *DxfStatus);
LIntExport Herror read_polygon_xld_dxf(Halcon::Hobject *Polygons, const char *FileName, const char *GenParamName, double GenParamValue, char *DxfStatus);
...
LIntExport Herror read_contour_xld_dxf(Halcon::Hobject *Contours, const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *DxfStatus);
LIntExport Herror read_contour_xld_dxf(Halcon::Hobject *Contours, const Halcon::HTuple &FileName, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, char *DxfStatus);
LIntExport Herror read_contour_xld_dxf(Halcon::Hobject *Contours, const char *FileName, const char *GenParamName, double GenParamValue, Halcon::HTuple *DxfStatus);
LIntExport Herror read_contour_xld_dxf(Halcon::Hobject *Contours, const char *FileName, const char *GenParamName, double GenParamValue, char *DxfStatus);
...
LIntExport Herror find_data_code_2d(const Halcon::Hobject &Image, Halcon::Hobject *SymbolXLDs, const Halcon::HTuple &DataCodeHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ResultHandles, Halcon::HTuple *DecodedDataStrings);
LIntExport Herror find_data_code_2d(const Halcon::Hobject &Image, Halcon::Hobject *SymbolXLDs, const Halcon::HTuple &DataCodeHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ResultHandles, char *DecodedDataStrings);
LIntExport Herror find_data_code_2d(const Halcon::Hobject &Image,Halcon::Hobject *SymbolXLDs, Hlong DataCodeHandle, const char *GenParamName, Hlong GenParamValue, Halcon::HTuple *ResultHandles, Halcon::HTuple *DecodedDataStrings);
LIntExport Herror find_data_code_2d(const Halcon::Hobject &Image, Halcon::Hobject *SymbolXLDs, Hlong DataCodeHandle, const char *GenParamName, Hlong GenParamValue, Hlong *ResultHandles, char *DecodedDataStrings);
LIntExport Herror set_data_code_2d_param(const Halcon::HTuple &DataCodeHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror get_data_code_2d_param(const Halcon::HTuple &DataCodeHandle, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_data_code_2d_param(const Halcon::HTuple &DataCodeHandle, const Halcon::HTuple &GenParamName, char *GenParamValue);
LIntExport Herror get_data_code_2d_param(Hlong DataCodeHandle, const char *GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_data_code_2d_param(Hlong DataCodeHandle, const char *GenParamName, char *GenParamValue);
LIntExport Herror query_data_code_2d_params(const Halcon::HTuple &DataCodeHandle, const Halcon::HTuple &QueryName, Halcon::HTuple *GenParamName);
LIntExport Herror query_data_code_2d_params(Hlong DataCodeHandle, const char *QueryName, Halcon::HTuple *GenParamName);
...
LIntExport Herror create_data_code_2d_model(const Halcon::HTuple &SymbolType, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *DataCodeHandle);
LIntExport Herror create_data_code_2d_model(const Halcon::HTuple &SymbolType, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *DataCodeHandle);
...
LIntExport Herror select_feature_set_mlp(const Halcon::HTuple &ClassTrainDataHandle, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *MLPHandle, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_mlp(Hlong ClassTrainDataHandle, const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *MLPHandle, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_svm(const Halcon::HTuple &ClassTrainDataHandle, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *SVMHandle, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_svm(Hlong ClassTrainDataHandle, const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *SVMHandle, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_gmm(const Halcon::HTuple &ClassTrainDataHandle, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *GMMHandle, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_gmm(Hlong ClassTrainDataHandle, const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *GMMHandle, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_knn(const Halcon::HTuple &ClassTrainDataHandle, const Halcon::HTuple &SelectionMethod, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *KNNHandle, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score);
LIntExport Herror select_feature_set_knn(Hlong ClassTrainDataHandle, const char *SelectionMethod, const char *GenParamName, double GenParamValue, Halcon::HTuple *KNNHandle, Halcon::HTuple *SelectedFeatureIndices, Halcon::HTuple *Score);
...
LIntExport Herror get_params_class_knn(const Halcon::HTuple &KNNHandle, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror set_params_class_knn(const Halcon::HTuple &KNNHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror train_class_knn(const Halcon::HTuple &KNNHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror create_class_lut_knn(const Halcon::HTuple &KNNHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ClassLUTHandle);
LIntExport Herror create_class_lut_knn(const Halcon::HTuple &KNNHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ClassLUTHandle);
LIntExport Herror create_class_lut_gmm(const Halcon::HTuple &GMMHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ClassLUTHandle);
LIntExport Herror create_class_lut_gmm(const Halcon::HTuple &GMMHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ClassLUTHandle);
LIntExport Herror create_class_lut_svm(const Halcon::HTuple &SVMHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ClassLUTHandle);
LIntExport Herror create_class_lut_svm(const Halcon::HTuple &SVMHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ClassLUTHandle);
LIntExport Herror create_class_lut_mlp(const Halcon::HTuple &MLPHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ClassLUTHandle);
LIntExport Herror create_class_lut_mlp(const Halcon::HTuple &MLPHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ClassLUTHandle);
...
LIntExport Herror get_camera_setup_param(const Halcon::HTuple &CameraSetupModelID, const Halcon::HTuple &CameraIdx, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_camera_setup_param(const Halcon::HTuple &CameraSetupModelID, const Halcon::HTuple &CameraIdx, const Halcon::HTuple &GenParamName, double *GenParamValue);
LIntExport Herror get_camera_setup_param(Hlong CameraSetupModelID, Hlong CameraIdx, const char *GenParamName, Halcon::HTuple *GenParamValue);
...
LIntExport Herror set_camera_setup_param(const Halcon::HTuple &CameraSetupModelID, const Halcon::HTuple &CameraIdx, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror get_bead_inspection_param(const Halcon::HTuple &BeadInspectionModel, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_bead_inspection_param(const Halcon::HTuple &BeadInspectionModel, const Halcon::HTuple &GenParamName, Hlong *GenParamValue);
LIntExport Herror get_bead_inspection_param(Hlong BeadInspectionModel, const char *GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_bead_inspection_param(Hlong BeadInspectionModel, const char *GenParamName, Hlong *GenParamValue);
LIntExport Herror set_bead_inspection_param(const Halcon::HTuple &BeadInspectionModel, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror create_bead_inspection_model(const Halcon::Hobject &BeadContour, const Halcon::HTuple &TargetThickness, const Halcon::HTuple &ThicknessTolerance, const Halcon::HTuple &PositionTolerance, const Halcon::HTuple &Polarity, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *BeadInspectionModel);
LIntExport Herror create_bead_inspection_model(const Halcon::Hobject &BeadContour, const Halcon::HTuple &TargetThickness, const Halcon::HTuple &ThicknessTolerance, const Halcon::HTuple &PositionTolerance, const Halcon::HTuple &Polarity, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *BeadInspectionModel);
LIntExport Herror create_bead_inspection_model(const Halcon::Hobject &BeadContour, Hlong TargetThickness, Hlong ThicknessTolerance, Hlong PositionTolerance, const char *Polarity, const char *GenParamName, Hlong GenParamValue, Halcon::HTuple *BeadInspectionModel);
LIntExport Herror create_bead_inspection_model(const Halcon::Hobject &BeadContour, Hlong TargetThickness, Hlong ThicknessTolerance, Hlong PositionTolerance, const char *Polarity, const char *GenParamName, Hlong GenParamValue, Hlong *BeadInspectionModel);
...
LIntExport Herror query_bar_code_params(const Halcon::HTuple &BarCodeHandle, const Halcon::HTuple &Properties, Halcon::HTuple *GenParamName);
LIntExport Herror query_bar_code_params(const Halcon::HTuple &BarCodeHandle, const Halcon::HTuple &Properties, char *GenParamName);
LIntExport Herror query_bar_code_params(Hlong BarCodeHandle, const char *Properties, Halcon::HTuple *GenParamName);
LIntExport Herror query_bar_code_params(Hlong BarCodeHandle, const char *Properties, char *GenParamName);
LIntExport Herror get_bar_code_param_specific(const Halcon::HTuple &BarCodeHandle, const Halcon::HTuple &CodeTypes, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_bar_code_param_specific(const Halcon::HTuple &BarCodeHandle, const Halcon::HTuple &CodeTypes, const Halcon::HTuple &GenParamName, double *GenParamValue);
LIntExport Herror get_bar_code_param_specific(Hlong BarCodeHandle, const char *CodeTypes, const char *GenParamName, Halcon::HTuple *GenParamValue);
...
LIntExport Herror get_bar_code_param(const Halcon::HTuple &BarCodeHandle, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_bar_code_param(const Halcon::HTuple &BarCodeHandle, const Halcon::HTuple &GenParamName, double *GenParamValue);
LIntExport Herror get_bar_code_param(Hlong BarCodeHandle, const char *GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_bar_code_param(Hlong BarCodeHandle, const char *GenParamName, double *GenParamValue);
LIntExport Herror set_bar_code_param_specific(const Halcon::HTuple &BarCodeHandle, const Halcon::HTuple &CodeTypes, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror set_bar_code_param(const Halcon::HTuple &BarCodeHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror create_bar_code_model(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *BarCodeHandle);
LIntExport Herror create_bar_code_model(const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *BarCodeHandle);
LIntExport Herror create_bar_code_model(const char *GenParamName, double GenParamValue, Halcon::HTuple *BarCodeHandle);
...
LIntExport Herror control_io_channel(const Halcon::HTuple &IOChannelHandle, const Halcon::HTuple &ParamAction, const Halcon::HTuple &ParamArgument, Halcon::HTuple *GenParamValue);
...
LIntExport Herror set_io_channel_param(const Halcon::HTuple &IOChannelHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror get_io_channel_param(const Halcon::HTuple &IOChannelHandle, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_io_channel_param(Hlong IOChannelHandle, const char *GenParamName, Halcon::HTuple *GenParamValue);
...
LIntExport Herror set_io_device_param(const Halcon::HTuple &IODeviceHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror get_io_device_param(const Halcon::HTuple &IODeviceHandle, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_io_device_param(const Halcon::HTuple &IODeviceHandle, const Halcon::HTuple &GenParamName, char *GenParamValue);
LIntExport Herror get_io_device_param(Hlong IODeviceHandle, const char *GenParamName, Halcon::HTuple *GenParamValue);
...
LIntExport Herror add_texture_inspection_model_image(const Halcon::Hobject &Image, const Halcon::HTuple &TextureInspectionModel, Halcon::HTuple *Indices);
LIntExport Herror add_texture_inspection_model_image(const Halcon::Hobject &Image, const Halcon::HTuple &TextureInspectionModel, Hlong *Indices);
LIntExport Herror add_texture_inspection_model_image(const Halcon::Hobject &Image, Hlong TextureInspectionModel, Halcon::HTuple *Indices);
LIntExport Herror add_texture_inspection_model_image(const Halcon::Hobject &Image, Hlong TextureInspectionModel, Hlong *Indices);
LIntExport Herror apply_texture_inspection_model(const Halcon::Hobject &Image, Halcon::Hobject *NoveltyRegion, const Halcon::HTuple &TextureInspectionModel, Halcon::HTuple *TextureInspectionResultID);
LIntExport Herror apply_texture_inspection_model(const Halcon::Hobject &Image, Halcon::Hobject *NoveltyRegion, const Halcon::HTuple &TextureInspectionModel, Hlong *TextureInspectionResultID);
LIntExport Herror apply_texture_inspection_model(const Halcon::Hobject &Image,Halcon::Hobject *NoveltyRegion, Hlong TextureInspectionModel, Halcon::HTuple *TextureInspectionResultID);
LIntExport Herror apply_texture_inspection_model(const Halcon::Hobject &Image, Halcon::Hobject *NoveltyRegion, Hlong TextureInspectionModel, Hlong *TextureInspectionResultID);
LIntExport Herror bilateral_filter(const Halcon::Hobject &Image, const Halcon::Hobject &ImageJoint, Halcon::Hobject *ImageBilateral, const Halcon::HTuple &SigmaSpatial, const Halcon::HTuple &SigmaRange, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror bilateral_filter(const Halcon::Hobject &Image, const Halcon::Hobject &ImageJoint,Halcon::Hobject *ImageBilateral, double SigmaSpatial, double SigmaRange, const char *GenParamName, double GenParamValue);
LIntExport Herror clear_ocr_class_cnn(const Halcon::HTuple &OCRHandle);
LIntExport Herror clear_ocr_class_cnn(Hlong OCRHandle);
LIntExport Herror clear_texture_inspection_model(const Halcon::HTuple &TextureInspectionModel);
LIntExport Herror clear_texture_inspection_model(Hlong TextureInspectionModel);
LIntExport Herror clear_texture_inspection_result(const Halcon::HTuple &TextureInspectionResultID);
LIntExport Herror clear_texture_inspection_result(Hlong TextureInspectionResultID);
LIntExport Herror convert_coordinates_image_to_window(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &RowImage, const Halcon::HTuple &ColumnImage, Halcon::HTuple *RowWindow, Halcon::HTuple *ColumnWindow);
LIntExport Herror convert_coordinates_image_to_window(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &RowImage, const Halcon::HTuple &ColumnImage, double *RowWindow, double *ColumnWindow);
LIntExport Herror convert_coordinates_image_to_window(Hlong WindowHandle, double RowImage, double ColumnImage, Halcon::HTuple *RowWindow, Halcon::HTuple *ColumnWindow);
...
LIntExport Herror convert_coordinates_window_to_image(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &RowWindow, const Halcon::HTuple &ColumnWindow, Halcon::HTuple *RowImage, Halcon::HTuple *ColumnImage);
LIntExport Herror convert_coordinates_window_to_image(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &RowWindow, const Halcon::HTuple &ColumnWindow, double *RowImage, double *ColumnImage);
LIntExport Herror convert_coordinates_window_to_image(Hlong WindowHandle, double RowWindow, double ColumnWindow, Halcon::HTuple *RowImage, Halcon::HTuple *ColumnImage);
...
LIntExport Herror create_texture_inspection_model(const Halcon::HTuple &ModelType, Halcon::HTuple *TextureInspectionModel);
LIntExport Herror create_texture_inspection_model(const Halcon::HTuple &ModelType, Hlong *TextureInspectionModel);
LIntExport Herror create_texture_inspection_model(const char *ModelType, Halcon::HTuple *TextureInspectionModel);
LIntExport Herror create_texture_inspection_model(const char *ModelType, Hlong *TextureInspectionModel);
LIntExport Herror deserialize_dual_quat(const Halcon::HTuple &SerializedItemHandle, Halcon::HTuple *DualQuaternion);
LIntExport Herror deserialize_dual_quat(Hlong SerializedItemHandle, Halcon::HTuple *DualQuaternion);
LIntExport Herror deserialize_ocr_class_cnn(const Halcon::HTuple &SerializedItemHandle, Halcon::HTuple *OCRHandle);
LIntExport Herror deserialize_ocr_class_cnn(const Halcon::HTuple &SerializedItemHandle, Hlong *OCRHandle);
LIntExport Herror deserialize_ocr_class_cnn(Hlong SerializedItemHandle, Halcon::HTuple *OCRHandle);
LIntExport Herror deserialize_ocr_class_cnn(Hlong SerializedItemHandle, Hlong *OCRHandle);
LIntExport Herror deserialize_texture_inspection_model(const Halcon::HTuple &SerializedItemHandle, Halcon::HTuple *TextureInspectionModel);
LIntExport Herror deserialize_texture_inspection_model(const Halcon::HTuple &SerializedItemHandle, Hlong *TextureInspectionModel);
LIntExport Herror deserialize_texture_inspection_model(Hlong SerializedItemHandle, Halcon::HTuple *TextureInspectionModel);
LIntExport Herror deserialize_texture_inspection_model(Hlong SerializedItemHandle, Hlong *TextureInspectionModel);
LIntExport Herror disp_text(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &String, const Halcon::HTuple &CoordSystem, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Color, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror do_ocr_multi_class_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const Halcon::HTuple &OCRHandle, Halcon::HTuple *Class, Halcon::HTuple *Confidence);
LIntExport Herror do_ocr_multi_class_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const Halcon::HTuple &OCRHandle, char *Class, double *Confidence);
LIntExport Herror do_ocr_multi_class_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, Hlong OCRHandle, Halcon::HTuple *Class, Halcon::HTuple *Confidence);
LIntExport Herror do_ocr_multi_class_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, Hlong OCRHandle, char *Class, double *Confidence);
LIntExport Herror do_ocr_single_class_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const Halcon::HTuple &OCRHandle, const Halcon::HTuple &Num, Halcon::HTuple *Class, Halcon::HTuple *Confidence);
LIntExport Herror do_ocr_single_class_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const Halcon::HTuple &OCRHandle, const Halcon::HTuple &Num, char *Class, double *Confidence);
LIntExport Herror do_ocr_word_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const Halcon::HTuple &OCRHandle, const Halcon::HTuple &Expression, const Halcon::HTuple &NumAlternatives, const Halcon::HTuple &NumCorrections, Halcon::HTuple *Class, Halcon::HTuple *Confidence, Halcon::HTuple *Word, Halcon::HTuple *Score);
LIntExport Herror do_ocr_word_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const Halcon::HTuple &OCRHandle, const Halcon::HTuple &Expression, const Halcon::HTuple &NumAlternatives, const Halcon::HTuple &NumCorrections, char *Class, double *Confidence, char *Word, double *Score);
LIntExport Herror do_ocr_word_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, Hlong OCRHandle, const char *Expression, Hlong NumAlternatives, Hlong NumCorrections, Halcon::HTuple *Class, Halcon::HTuple *Confidence, Halcon::HTuple *Word, Halcon::HTuple *Score);
LIntExport Herror do_ocr_word_cnn(const Halcon::Hobject &Character, const Halcon::Hobject &Image, Hlong OCRHandle, const char *Expression, Hlong NumAlternatives, Hlong NumCorrections, char *Class, double *Confidence, char *Word, double *Score);
LIntExport Herror dual_quat_compose(const Halcon::HTuple &DualQuaternionLeft, const Halcon::HTuple &DualQuaternionRight, Halcon::HTuple *DualQuaternionComposed);
LIntExport Herror dual_quat_conjugate(const Halcon::HTuple &DualQuaternion, Halcon::HTuple *DualQuaternionConjugate);
LIntExport Herror dual_quat_interpolate(const Halcon::HTuple &DualQuaternionStart, const Halcon::HTuple &DualQuaternionEnd, const Halcon::HTuple &InterpPos, Halcon::HTuple *DualQuaternionInterpolated);
LIntExport Herror dual_quat_normalize(const Halcon::HTuple &DualQuaternion, Halcon::HTuple *DualQuaternionNormalized);
LIntExport Herror dual_quat_to_hom_mat3d(const Halcon::HTuple &DualQuaternion, Halcon::HTuple *HomMat3D);
LIntExport Herror dual_quat_to_pose(const Halcon::HTuple &DualQuaternion, Halcon::HTuple *Pose);
LIntExport Herror dual_quat_to_screw(const Halcon::HTuple &DualQuaternion, const Halcon::HTuple &ScrewFormat, Halcon::HTuple *AxisDirectionX, Halcon::HTuple *AxisDirectionY, Halcon::HTuple *AxisDirectionZ, Halcon::HTuple *AxisMomentOrPointX, Halcon::HTuple *AxisMomentOrPointY, Halcon::HTuple *AxisMomentOrPointZ, Halcon::HTuple *Rotation, Halcon::HTuple *Translation);
LIntExport Herror dual_quat_to_screw(const Halcon::HTuple &DualQuaternion, const Halcon::HTuple &ScrewFormat, double *AxisDirectionX, double *AxisDirectionY, double *AxisDirectionZ, double *AxisMomentOrPointX, double *AxisMomentOrPointY, double *AxisMomentOrPointZ, double *Rotation, double *Translation);
LIntExport Herror dual_quat_trans_line_3d(const Halcon::HTuple &DualQuaternion, const Halcon::HTuple &LineFormat, const Halcon::HTuple &LineDirectionX, const Halcon::HTuple &LineDirectionY, const Halcon::HTuple &LineDirectionZ, const Halcon::HTuple &LineMomentOrPointX, const Halcon::HTuple &LineMomentOrPointY, const Halcon::HTuple &LineMomentOrPointZ, Halcon::HTuple *TransLineDirectionX, Halcon::HTuple *TransLineDirectionY, Halcon::HTuple *TransLineDirectionZ, Halcon::HTuple *TransLineMomentOrPointX, Halcon::HTuple *TransLineMomentOrPointY, Halcon::HTuple *TransLineMomentOrPointZ);
LIntExport Herror dual_quat_trans_line_3d(const Halcon::HTuple &DualQuaternion, const Halcon::HTuple &LineFormat, const Halcon::HTuple &LineDirectionX, const Halcon::HTuple &LineDirectionY, const Halcon::HTuple &LineDirectionZ, const Halcon::HTuple &LineMomentOrPointX, const Halcon::HTuple &LineMomentOrPointY, const Halcon::HTuple &LineMomentOrPointZ, double *TransLineDirectionX, double *TransLineDirectionY, double *TransLineDirectionZ, double *TransLineMomentOrPointX, double *TransLineMomentOrPointY, double *TransLineMomentOrPointZ);
LIntExport Herror edges_object_model_3d(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &MinAmplitude, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *ObjectModel3DEdges);
LIntExport Herror edges_object_model_3d(const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &MinAmplitude, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Hlong *ObjectModel3DEdges);
LIntExport Herror edges_object_model_3d(Hlong ObjectModel3D, double MinAmplitude, const char *GenParamName, double GenParamValue, Halcon::HTuple *ObjectModel3DEdges);
...
LIntExport Herror find_ncc_models(const Halcon::Hobject &Image, const Halcon::HTuple &ModelIDs, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &MaxOverlap, const Halcon::HTuple &SubPixel, const Halcon::HTuple &NumLevels, Halcon::HTuple *Row, Halcon::HTuple *Column, Halcon::HTuple *Angle, Halcon::HTuple *Score, Halcon::HTuple *Model);
LIntExport Herror find_ncc_models(const Halcon::Hobject &Image, Hlong ModelIDs, double AngleStart, double AngleExtent, double MinScore, Hlong NumMatches, double MaxOverlap, const char *SubPixel, Hlong NumLevels, Halcon::HTuple *Row, Halcon::HTuple *Column, Halcon::HTuple *Angle, Halcon::HTuple *Score, Halcon::HTuple *Model);
LIntExport Herror find_surface_model_image(const Halcon::Hobject &Image, const Halcon::HTuple &SurfaceModelID, const Halcon::HTuple &ObjectModel3D, const Halcon::HTuple &RelSamplingDistance, const Halcon::HTuple &KeyPointFraction, const Halcon::HTuple &MinScore, const Halcon::HTuple &ReturnResultHandle, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue, Halcon::HTuple *Pose, Halcon::HTuple *Score, Halcon::HTuple *SurfaceMatchingResultID);
LIntExport Herror flush_buffer(const Halcon::HTuple &WindowHandle);
LIntExport Herror flush_buffer(Hlong WindowHandle);
LIntExport Herror get_ncc_model_region(Halcon::Hobject *ModelRegion, const Halcon::HTuple &ModelID);
LIntExport Herror get_ncc_model_region(Halcon::Hobject *ModelRegion, Hlong ModelID);
LIntExport Herror get_params_ocr_class_cnn(const Halcon::HTuple &OCRHandle, const Halcon::HTuple &GenParamNames, Halcon::HTuple *GenParamValues);
LIntExport Herror get_params_ocr_class_cnn(const Halcon::HTuple &OCRHandle, const Halcon::HTuple &GenParamNames, Hlong *GenParamValues);
LIntExport Herror get_params_ocr_class_cnn(Hlong OCRHandle, const char *GenParamNames, Halcon::HTuple *GenParamValues);
LIntExport Herror get_params_ocr_class_cnn(Hlong OCRHandle, const char *GenParamNames, Hlong *GenParamValues);
LIntExport Herror get_rgba(const Halcon::HTuple &WindowHandle, Halcon::HTuple *Red, Halcon::HTuple *Green, Halcon::HTuple *Blue, Halcon::HTuple *Alpha);
LIntExport Herror get_rgba(Hlong WindowHandle, Halcon::HTuple *Red, Halcon::HTuple *Green, Halcon::HTuple *Blue, Halcon::HTuple *Alpha);
LIntExport Herror get_stereo_model_object_model_3d(const Halcon::HTuple &StereoModelID, const Halcon::HTuple &GenParamName, Halcon::HTuple *ObjectModel3D);
LIntExport Herror get_stereo_model_object_model_3d(const Halcon::HTuple &StereoModelID, const Halcon::HTuple &GenParamName, Hlong *ObjectModel3D);
LIntExport Herror get_stereo_model_object_model_3d(Hlong StereoModelID, const char *GenParamName, Halcon::HTuple *ObjectModel3D);
LIntExport Herror get_stereo_model_object_model_3d(Hlong StereoModelID, const char *GenParamName, Hlong *ObjectModel3D);
LIntExport Herror get_texture_inspection_model_image(Halcon::Hobject *ImageOut, const Halcon::HTuple &TextureInspectionModel);
LIntExport Herror get_texture_inspection_model_image(Halcon::Hobject *ImageOut, Hlong TextureInspectionModel);
LIntExport Herror get_texture_inspection_model_param(const Halcon::HTuple &TextureInspectionModel, const Halcon::HTuple &GenParamName, Halcon::HTuple *GenParamValue);
LIntExport Herror get_texture_inspection_model_param(const Halcon::HTuple &TextureInspectionModel, const Halcon::HTuple &GenParamName, Hlong *GenParamValue);
LIntExport Herror get_texture_inspection_model_param(Hlong TextureInspectionModel, const char *GenParamName, Halcon::HTuple *GenParamValue);
...
LIntExport Herror get_texture_inspection_result_object(Halcon::Hobject *Object, const Halcon::HTuple &TextureInspectionResultID, const Halcon::HTuple &ResultName);
LIntExport Herror guided_filter(const Halcon::Hobject &Image, const Halcon::Hobject &ImageGuide, Halcon::Hobject *ImageGuided, const Halcon::HTuple &Radius, const Halcon::HTuple &Amplitude);
LIntExport Herror guided_filter(const Halcon::Hobject &Image, const Halcon::Hobject &ImageGuide,Halcon::Hobject *ImageGuided, Hlong Radius, double Amplitude);
LIntExport Herror interleave_channels(const Halcon::Hobject &MultichannelImage, Halcon::Hobject *InterleavedImage, const Halcon::HTuple &PixelFormat, const Halcon::HTuple &RowBytes, const Halcon::HTuple &Alpha);
LIntExport Herror pose_to_dual_quat(const Halcon::HTuple &Pose, Halcon::HTuple *DualQuaternion);
LIntExport Herror query_params_ocr_class_cnn(const Halcon::HTuple &OCRHandle, Halcon::HTuple *GenParamNames);
LIntExport Herror query_params_ocr_class_cnn(const Halcon::HTuple &OCRHandle, char *GenParamNames);
LIntExport Herror query_params_ocr_class_cnn(Hlong OCRHandle, Halcon::HTuple *GenParamNames);
LIntExport Herror query_params_ocr_class_cnn(Hlong OCRHandle, char *GenParamNames);
LIntExport Herror read_ocr_class_cnn(const Halcon::HTuple &FileName, Halcon::HTuple *OCRHandle);
LIntExport Herror read_ocr_class_cnn(const Halcon::HTuple &FileName, Hlong *OCRHandle);
LIntExport Herror read_ocr_class_cnn(const char *FileName, Halcon::HTuple *OCRHandle);
LIntExport Herror read_ocr_class_cnn(const char *FileName, Hlong *OCRHandle);
LIntExport Herror read_texture_inspection_model(const Halcon::HTuple &FileName, Halcon::HTuple *TextureInspectionModel);
LIntExport Herror read_texture_inspection_model(const Halcon::HTuple &FileName, Hlong *TextureInspectionModel);
LIntExport Herror read_texture_inspection_model(const char *FileName, Halcon::HTuple *TextureInspectionModel);
...
LIntExport Herror remove_texture_inspection_model_image(const Halcon::HTuple &TextureInspectionModel, const Halcon::HTuple &Indices, Halcon::HTuple *RemainingIndices);
LIntExport Herror screw_to_dual_quat(const Halcon::HTuple &ScrewFormat, const Halcon::HTuple &AxisDirectionX, const Halcon::HTuple &AxisDirectionY, const Halcon::HTuple &AxisDirectionZ, const Halcon::HTuple &AxisMomentOrPointX, const Halcon::HTuple &AxisMomentOrPointY, const Halcon::HTuple &AxisMomentOrPointZ, const Halcon::HTuple &Rotation, const Halcon::HTuple &Translation, Halcon::HTuple *DualQuaternion);
LIntExport Herror screw_to_dual_quat(const char *ScrewFormat, double AxisDirectionX, double AxisDirectionY, double AxisDirectionZ, double AxisMomentOrPointX, double AxisMomentOrPointY, double AxisMomentOrPointZ, double Rotation, double Translation, Halcon::HTuple *DualQuaternion);
LIntExport Herror segment_image_mser(const Halcon::Hobject &Image, Halcon::Hobject *MSERDark, Halcon::Hobject *MSERLight, const Halcon::HTuple &Polarity, const Halcon::HTuple &MinArea, const Halcon::HTuple &MaxArea, const Halcon::HTuple &Delta, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror send_mouse_double_click_event(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button, Halcon::HTuple *Processed);
LIntExport Herror send_mouse_double_click_event(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button, char *Processed);
LIntExport Herror send_mouse_double_click_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, Halcon::HTuple *Processed);
LIntExport Herror send_mouse_double_click_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, char *Processed);
LIntExport Herror send_mouse_down_event(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button, Halcon::HTuple *Processed);
LIntExport Herror send_mouse_down_event(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button, char *Processed);
LIntExport Herror send_mouse_down_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, Halcon::HTuple *Processed);
LIntExport Herror send_mouse_down_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, char *Processed);
LIntExport Herror send_mouse_drag_event(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button, Halcon::HTuple *Processed);
LIntExport Herror send_mouse_drag_event(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button, char *Processed);
LIntExport Herror send_mouse_drag_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, Halcon::HTuple *Processed);
LIntExport Herror send_mouse_drag_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, char *Processed);
LIntExport Herror send_mouse_up_event(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button, Halcon::HTuple *Processed);
LIntExport Herror send_mouse_up_event(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &Button, char *Processed);
LIntExport Herror send_mouse_up_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, Halcon::HTuple *Processed);
LIntExport Herror send_mouse_up_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, char *Processed);
LIntExport Herror serialize_dual_quat(const Halcon::HTuple &DualQuaternion, Halcon::HTuple *SerializedItemHandle);
LIntExport Herror serialize_dual_quat(const Halcon::HTuple &DualQuaternion, Hlong *SerializedItemHandle);
LIntExport Herror serialize_ocr_class_cnn(const Halcon::HTuple &OCRHandle, Halcon::HTuple *SerializedItemHandle);
LIntExport Herror serialize_ocr_class_cnn(const Halcon::HTuple &OCRHandle, Hlong *SerializedItemHandle);
LIntExport Herror serialize_ocr_class_cnn(Hlong OCRHandle, Halcon::HTuple *SerializedItemHandle);
LIntExport Herror serialize_ocr_class_cnn(Hlong OCRHandle, Hlong *SerializedItemHandle);
LIntExport Herror serialize_texture_inspection_model(const Halcon::HTuple &TextureInspectionModel, Halcon::HTuple *SerializedItemHandle);
LIntExport Herror serialize_texture_inspection_model(const Halcon::HTuple &TextureInspectionModel, Hlong *SerializedItemHandle);
LIntExport Herror serialize_texture_inspection_model(Hlong TextureInspectionModel, Halcon::HTuple *SerializedItemHandle);
LIntExport Herror serialize_texture_inspection_model(Hlong TextureInspectionModel, Hlong *SerializedItemHandle);
LIntExport Herror set_content_update_callback(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &CallbackFunction, const Halcon::HTuple &CallbackContext);
LIntExport Herror set_content_update_callback(Hlong WindowHandle, Hlong CallbackFunction, Hlong CallbackContext);
LIntExport Herror set_rgba(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &Red, const Halcon::HTuple &Green, const Halcon::HTuple &Blue, const Halcon::HTuple &Alpha);
LIntExport Herror set_rgba(Hlong WindowHandle, Hlong Red, Hlong Green, Hlong Blue, Hlong Alpha);
LIntExport Herror set_surface_model_param(const Halcon::HTuple &SurfaceModelID, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
LIntExport Herror set_surface_model_param(Hlong SurfaceModelID, const char *GenParamName, double GenParamValue);
LIntExport Herror set_texture_inspection_model_param(const Halcon::HTuple &TextureInspectionModel, const Halcon::HTuple &GenParamName, const Halcon::HTuple &GenParamValue);
...
LIntExport Herror train_texture_inspection_model(const Halcon::HTuple &TextureInspectionModel);
LIntExport Herror train_texture_inspection_model(Hlong TextureInspectionModel);
LIntExport Herror write_texture_inspection_model(const Halcon::HTuple &TextureInspectionModel, const Halcon::HTuple &FileName);
