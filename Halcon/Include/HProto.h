...
LIntExport Herror T_get_params_ocr_class_cnn(const Htuple OCRHandle, const Htuple GenParamNames, Htuple *GenParamValues);
...
LIntExport Herror T_query_params_ocr_class_cnn(const Htuple OCRHandle, Htuple *GenParamNames);
