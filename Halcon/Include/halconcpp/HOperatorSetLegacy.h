...
LIntExport Herror get_params_ocr_class_cnn(const HTuple& OCRHandle, const HTuple& GenParamNames, HTuple* GenParamValues);
...
LIntExport Herror query_params_ocr_class_cnn(const HTuple& OCRHandle, HTuple* GenParamNames);
